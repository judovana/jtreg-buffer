 ...
 * @run main/othervm FontDisposeTest fonts/bchb.pfa
 * @run main/othervm FontDisposeTest fonts/bchri.pfa
 * @run main/othervm FontDisposeTest fonts/bchr.pfa
 * @run main/othervm FontDisposeTest fonts/hrger.pfa
 * @run main/othervm FontDisposeTest fonts/hrgrr.pfa
 * @run main/othervm FontDisposeTest fonts/hritr.pfa
 * @run main/othervm FontDisposeTest fonts/hrpldi.pfa
 * @run main/othervm FontDisposeTest fonts/hrpld.pfa
 * @run main/othervm FontDisposeTest fonts/hrplti.pfa
 * @run main/othervm FontDisposeTest fonts/hrplt.pfa
 * @run main/othervm FontDisposeTest fonts/hrscc.pfa
 * @run main/othervm FontDisposeTest fonts/hrscs.pfa
 * @run main/othervm FontDisposeTest fonts/putbi.pfa
 * @run main/othervm FontDisposeTest fonts/putb.pfa
 * @run main/othervm FontDisposeTest fonts/putri.pfa
 * @run main/othervm FontDisposeTest fonts/putr.pfa
 */
public class FontDisposeTest
{
    public static void main(String[] args) throws Exception
    {
        ...
        String path = System.getProperty("test.src") + File.separator + args[0];
